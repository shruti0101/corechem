...
>
  ...
  <div className="relative mx-auto max-w-7xl px-6 py-28 lg:py-36">
    <div className="max-w-4xl">
      <span className="inline-flex items-center rounded-full border border-orange-200 bg-white/90 px-5 py-2 text-sm font-semibold text-[#ff5e14] shadow-md backdrop-blur-md">
        Trusted Titanium Dioxide Supplier
      </span>

      <h1 className="mt-8 text-5xl font-extrabold leading-tight text-[#1e293b] md:text-7xl">
        About{" "}
        <span className="bg-gradient-to-r from-[#ff5e14] to-orange-500 bg-clip-text text-transparent">
          Corechem
        </span>{" "}
        Corporation
      </h1>
            ...
            <div className="relative rounded-[32px] border border-white bg-white/90 p-10 shadow-[0_20px_80px_rgba(15,23,42,0.08)] backdrop-blur-xl">
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  >
                    <h3 className="text-4xl font-bold text-[#ff5e14]">
                      {item[0]}
                    </h3>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {products.map((item, index) => (
              <div
                key={index}
                className="group rounded-[30px] border border-slate-200 bg-[#fcfcfd] p-8 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-[#ff5e14]/30 hover:shadow-xl"
              >
                <div className="inline-flex rounded-2xl bg-orange-100 p-4 text-[#ff5e14]">
                  {item.icon}
                </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-18">
        <div className="grid gap-10 lg:grid-cols-2">
          <div className="rounded-[30px] border border-orange-100 bg-gradient-to-br from-orange-50 to-white p-10 shadow-sm">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Our mission is to deliver high-quality Titanium Dioxide materials
              and reliable chemical supply solutions that address the changing
          ...
          <div className="rounded-[30px] border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-10 shadow-sm">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-600">
              We are committed to sustainable growth and operational excellence.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-10  grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {whyChoose.map((item, index) => (
              <div
                key={index}
                className="rounded-[30px] border border-slate-200 bg-[#fcfcfd] p-8 shadow-sm transition hover:-translate-y-1 hover:border-[#ff5e14]/30 hover:shadow-xl"
              >
                <div className="inline-flex rounded-2xl bg-orange-100 p-4 text-[#ff5e14]">
                  {item.icon}
                </div>
  ...
  <div className="relative mx-auto max-w-5xl px-6">
    <div className="rounded-[36px] border border-white/70 bg-white/85 p-10 text-center shadow-[0_20px_80px_rgba(15,23,42,0.12)] backdrop-blur-xl md:p-16">
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-4">
        <Link
          href="/contact"
          className="rounded-xl bg-[#ff5e14] px-6 py-4 font-semibold text-white shadow-lg transition hover:bg-[#e55312]"
        >
          Request a Quote
        </Link>
        ...
        <Link
          href="/products"
          className="rounded-xl border border-slate-200 bg-white px-6 py-4 font-semibold text-slate-700 shadow-sm transition hover:border-[#ff5e14] hover:text-[#ff5e14]"
        >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-orange-200 bg-orange-50 px-6 py-4 font-semibold text-[#ff5e14] transition hover:bg-orange-100"
        >
