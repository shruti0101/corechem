          ...
          {industries.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* ORANGE SHAPE */}
                <div className="absolute bottom-[-30px] right-[20px] h-[120px] w-[120px] rounded-full bg-[#BE8220]/10 blur-[40px]" />
                ...
                {/* HOVER BORDER */}
                <div className="absolute inset-0 border border-transparent transition-all duration-500 group-hover:border-[#BE8220]/40" />
              </div>
            );
          })}
        </div>
