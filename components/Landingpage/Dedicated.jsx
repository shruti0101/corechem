...
export default function TitaniumDioxideSection() {
  return (
    <section className="relative overflow-hidden bg-[#f7f8fa] py-[60px] sm:py-[80px] lg:py-[110px] px-3">
        ...
        <div className="grid items-center gap-[45px] lg:gap-[60px] xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div>
            ...
            <div className="flex items-center gap-[14px]">
              <span className="h-[2px] w-[50px] sm:w-[65px] bg-[#ff5e14]" />

              <span className="uppercase tracking-[2px] sm:tracking-[3px] text-[11px] sm:text-[13px] font-[700] text-[#ff5e14]">
            ...
            <div className="mt-[32px] flex flex-col sm:flex-row gap-[16px]">
              ...
              {/* PRIMARY BUTTON */}
              <button className="group relative inline-flex h-[62px] sm:h-[68px] w-full sm:w-auto items-center justify-center overflow-hidden rounded-full bg-[#ff5e14] px-[24px] sm:px-[34px] text-white shadow-[0_20px_50px_rgba(255,94,20,0.25)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_25px_60px_rgba(255,94,20,0.35)]">
            ...
            <div className="relative z-10 flex h-full flex-col justify-between p-[22px] sm:p-[40px]">
              ...
              <div>
                ...
                <div className="mt-[32px] space-y-[18px]">
                  ...
                  {[
                    ...
                    >
                      {/* ICON */}
                      <div className="mt-[3px] flex h-[26px] w-[26px] shrink-0 items-center justify-center rounded-full bg-[#ff5e14]/20 text-[#ff5e14] backdrop-blur-xl">
              ...
              <div className="mt-[30px] grid grid-cols-2 gap-[14px] sm:gap-[16px]">
                ...
                <div className="rounded-[22px] border border-white/10 bg-white/10 p-[18px] sm:p-[22px] backdrop-blur-xl transition-all duration-300 hover:bg-white/15">
                  ...
                  <h4 className="text-[#ff5e14] text-[34px] sm:text-[40px] leading-none font-[700]">
                    99%
                  </h4>
