...
export default function Industry() {
  return (
    <section className="bg-gradient-to-b from-white to-slate-50 py-8 md:py-15 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mb-14 text-center">
          ...
          <h2 className="mt-5 text-4xl font-bold text-[#062347] md:text-6xl">
            Industries We Serve
          </h2>

          <div className="mx-auto mt-5 h-1.5 w-28 rounded-full bg-[#c8921c]" />
        </div>
          ...
          {industries.map((item, index) => {
            ...
            return (
              <SwiperSlide key={index}>
                <div className="group mb-4 mb:0 h-[220px] md:h-[260px] rounded-[30px] border border-gray-100 bg-white p-4 md:p-8 shadow-lg transition-all duration-500 hover:-translate-y-3 hover:border-[#c8921c] hover:shadow-2xl">
                  {/* Icon */}
                  ...
                  {/* Line */}
                  <div className="mx-auto mt-5 h-1 w-12 rounded-full bg-[#c8921c] transition-all duration-500 group-hover:w-20" />
                </div>
              </SwiperSlide>
            );
          })}
